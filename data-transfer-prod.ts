...
const targetProfile = "ffv2-prod"; // target-profile-name
...
const sourceTableName = "single-dynamodb-table-ffv2-prod-stack";
const targetTableName = "single-dynamodb-table-ffv2-new-prod-stack";
